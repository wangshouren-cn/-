...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8a3d00d6cabd4093b7ce7121464d5bb2~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fe73069469414debbef973c6a9f0f8ae~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7e0957eaa8d1444f98a80173502f2395~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0380e4bb149540649fc8b5f7f8e71c6e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp?)
...
[![Chin是我啊的头像](https://p3-passport.byteacctimg.com/img/user-avatar/644124178605c5f1ad21c03c38d9cf58~300x300.image)](https://juejin.cn/user/598555237295264)

[Chin是我啊![lv-1](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/636691cd590f92898cfcda37357472b8.svg)](https://juejin.cn/user/598555237295264)

菜鸟前端实习生1小时前

自动修复代码风格那个脚本好像并没有起到自动修复的作用，有遇到相同问题的小伙伴吗
...
常用的 type 值:
perf(性能优化) performance 的简写 不是`pref`
...
添加了stylelint相关配置，进行样式校验时提示 Unknown word  CssSyntaxError，这个是为啥

点赞

回复

[![刘小灰的头像](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/7/16/1735834d7be9d504~tplv-t2oaga2asx-no-mark:100:100:100:100.awebp)](https://juejin.cn/user/3438928104003758)
...
有时候eslint和Prettier格式化代码会有冲突，有什么好的处理方案吗

点赞

1

[![img](https://p3-passport.byteacctimg.com/img/user-avatar/334b45d5f9918f1a3f4f5ad91d497d65~300x300.image)](https://juejin.cn/user/2576910987300168)

[十一同学](https://juejin.cn/user/2576910987300168)

2天前

这个问题我也想知道，按照操作走一片红还得自己处理。

点赞

回复

[![爱养鱼的技术宅的头像](https://p3-passport.byteacctimg.com/img/user-avatar/ea961753af6ba1562ed10cf8a1188c08~300x300.image)](https://juejin.cn/user/3509296846081000)

[爱养鱼的技术宅](https://juejin.cn/user/3509296846081000)

大前端伪全栈开发2天前

为什么选择 npx --no -- lint-staged ，而不是 npm runlint-staged 或者yarn lint-staged ，这样 npx --no -- lint-staged 是有什么好处吗

点赞

1

[![img](https://p9-passport.byteacctimg.com/img/user-avatar/af044fdcaffe2a50938ccf7fdd4b6b2a~300x300.image)](https://juejin.cn/user/466655448666878)

[YangZai![lv-1](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/636691cd590f92898cfcda37357472b8.svg)](https://juejin.cn/user/466655448666878)
...
pnpm i -D lint-stage ->pnpm i -D lint-staged
