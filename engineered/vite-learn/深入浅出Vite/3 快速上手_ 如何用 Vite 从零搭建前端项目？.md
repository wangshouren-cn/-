...
其次是安装 Node.js，如果你的系统中还没有安装 [`Node.js`](https://link.juejin.cn/?target=http%3A%2F%2Fnodejs.cn%2Fdownload%2Fcurrent%2F) ，可以进入 Nodejs 官网下载相应的安装包进行手动安装；如果已经安装了 `Node.js`，你可以使用这个命令检查一下 Node.js 版本:

```js
node -v
```

推荐 `12.0.0` 及以上版本，如果低于这个版本，推荐使用 [`nvm`](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fnvm-sh%2Fnvm) 工具切换 Nodejs 版本。
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f7ca5186aa324841ba4f038642e355f3~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d7ce24dcb52946168fa4e28773dabc7a~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5f4da134800544caacbc5834d347ff32~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2adc237d5bbd409ca9c32fb7d36aa272~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e77d3505dfb24a42b53c6c986fb83e71~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2a2eadd5fcd143c7aa55f12979d8b3f0~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

此时 Vite 已经生成了最终的打包产物，我们可以通过 `pnpm run preview` 命令预览一下打包产物的执行效果。

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e845b0e8c2f24b3a901bdc53754e80c9~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)
...
[![血月下的誓约的头像](https://p6-passport.byteacctimg.com/img/user-avatar/7dea19eeab9d96598c687a316e44685c~300x300.image)](https://juejin.cn/user/289926802317165)

[血月下的誓约](https://juejin.cn/user/289926802317165)

前端开发2小时前

项目根目录的index.html话，我倒是觉得“执行启动vite命令的同级目录中的index.html”

点赞

回复

[![阿彪肠粉店的头像](https://p26-passport.byteacctimg.com/img/user-avatar/dfed1fc1d45a3ffa6cf390823e538f09~300x300.image)](https://juejin.cn/user/835284567080311)

[阿彪肠粉店![lv-2](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/f597b88d22ce5370bd94495780459040.svg)](https://juejin.cn/user/835284567080311)

前端肠粉工程师 @ 阿彪肠粉有限公司8小时前
...
[![Danile的头像](https://p6-passport.byteacctimg.com/img/user-avatar/835413355c763b3d9b49653dfcf8403b~300x300.image)](https://juejin.cn/user/1943592288659325)

[Danile![lv-1](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/636691cd590f92898cfcda37357472b8.svg)](https://juejin.cn/user/1943592288659325)
...
[![img](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/3f843e8626a3844c624fb596dddd9674.svg)registry.npmmirror.com](https://link.juejin.cn/?target=https%3A%2F%2Fregistry.npmmirror.com%2F) 淘宝源新地址应该是这个

3

2

[![img](https://p9-passport.byteacctimg.com/img/user-avatar/0d83531202d06e281a9bb609888bd648~300x300.image)](https://juejin.cn/user/1415826704971918)

[若川![lv-5](https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/f8d51984638784aff27209d38b6cd3bf.svg)](https://juejin.cn/user/1415826704971918)
